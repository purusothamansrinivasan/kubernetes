...
func Listeventsv1beta1namespacedeventHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListeventsv1beta1namespacedeventTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_events.k8s.io_v1beta1_namespaces_namespace_events",
		mcp.WithDescription("list or watch objects of kind Event"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listeventsv1beta1namespacedeventHandler(cfg),
	}
}

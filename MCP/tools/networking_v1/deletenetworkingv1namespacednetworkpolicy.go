...
func Deletenetworkingv1namespacednetworkpolicyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeletenetworkingv1namespacednetworkpolicyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_networking.k8s.io_v1_namespaces_namespace_networkpolicies_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deletenetworkingv1namespacednetworkpolicyHandler(cfg),
	}
}

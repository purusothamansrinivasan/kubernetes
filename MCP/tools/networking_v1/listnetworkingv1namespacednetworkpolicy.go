...
func Listnetworkingv1namespacednetworkpolicyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListnetworkingv1namespacednetworkpolicyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_networking.k8s.io_v1_namespaces_namespace_networkpolicies",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listnetworkingv1namespacednetworkpolicyHandler(cfg),
	}
}

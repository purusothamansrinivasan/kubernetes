...
func Deletestoragev1beta1storageclassHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeletestoragev1beta1storageclassTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_storage.k8s.io_v1beta1_storageclasses_name",
		mcp.WithDescription("delete a StorageClass"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deletestoragev1beta1storageclassHandler(cfg),
	}
}

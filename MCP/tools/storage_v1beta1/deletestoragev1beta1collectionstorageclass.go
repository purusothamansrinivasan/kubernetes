...
func Deletestoragev1beta1collectionstorageclassHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeletestoragev1beta1collectionstorageclassTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_storage.k8s.io_v1beta1_storageclasses",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deletestoragev1beta1collectionstorageclassHandler(cfg),
	}
}

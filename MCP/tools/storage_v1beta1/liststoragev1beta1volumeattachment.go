...
func Liststoragev1beta1volumeattachmentHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListstoragev1beta1volumeattachmentTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_storage.k8s.io_v1beta1_volumeattachments",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Liststoragev1beta1volumeattachmentHandler(cfg),
	}
}

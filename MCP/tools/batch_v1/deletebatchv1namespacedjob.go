...
func Deletebatchv1namespacedjobHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeletebatchv1namespacedjobTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_batch_v1_namespaces_namespace_jobs_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deletebatchv1namespacedjobHandler(cfg),
	}
}

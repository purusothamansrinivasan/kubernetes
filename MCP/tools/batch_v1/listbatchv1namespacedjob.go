...
func Listbatchv1namespacedjobHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListbatchv1namespacedjobTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_batch_v1_namespaces_namespace_jobs",
		mcp.WithDescription("list or watch objects of kind Job"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listbatchv1namespacedjobHandler(cfg),
	}
}

...
func Deletesettingsv1alpha1namespacedpodpresetHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeletesettingsv1alpha1namespacedpodpresetTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_settings.k8s.io_v1alpha1_namespaces_namespace_podpresets_name",
		mcp.WithDescription("delete a PodPreset"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deletesettingsv1alpha1namespacedpodpresetHandler(cfg),
	}
}

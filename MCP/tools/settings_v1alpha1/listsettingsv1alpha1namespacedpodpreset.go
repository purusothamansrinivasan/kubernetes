...
func Listsettingsv1alpha1namespacedpodpresetHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListsettingsv1alpha1namespacedpodpresetTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_settings.k8s.io_v1alpha1_namespaces_namespace_podpresets",
		mcp.WithDescription("list or watch objects of kind PodPreset"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listsettingsv1alpha1namespacedpodpresetHandler(cfg),
	}
}

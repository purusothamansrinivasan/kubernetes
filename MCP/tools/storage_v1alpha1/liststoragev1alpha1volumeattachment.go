...
func Liststoragev1alpha1volumeattachmentHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListstoragev1alpha1volumeattachmentTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_storage.k8s.io_v1alpha1_volumeattachments",
		mcp.WithDescription("list or watch objects of kind VolumeAttachment"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Liststoragev1alpha1volumeattachmentHandler(cfg),
	}
}

...
func Deletestoragev1alpha1volumeattachmentHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeletestoragev1alpha1volumeattachmentTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_storage.k8s.io_v1alpha1_volumeattachments_name",
		mcp.WithDescription("delete a VolumeAttachment"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deletestoragev1alpha1volumeattachmentHandler(cfg),
	}
}

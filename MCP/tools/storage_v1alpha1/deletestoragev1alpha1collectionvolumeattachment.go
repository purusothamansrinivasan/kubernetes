...
func Deletestoragev1alpha1collectionvolumeattachmentHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/storage.k8s.io/v1alpha1/volumeattachments%s", cfg.BaseURL, queryString)
...
func CreateDeletestoragev1alpha1collectionvolumeattachmentTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_storage.k8s.io_v1alpha1_volumeattachments",
		mcp.WithDescription("delete collection of VolumeAttachment"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deletestoragev1alpha1collectionvolumeattachmentHandler(cfg),
	}
}

...
func Deleteappsv1namespacedreplicasetHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeleteappsv1namespacedreplicasetTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_apps_v1_namespaces_namespace_replicasets_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deleteappsv1namespacedreplicasetHandler(cfg),
	}
}

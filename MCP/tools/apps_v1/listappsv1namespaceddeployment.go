...
func Listappsv1namespaceddeploymentHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListappsv1namespaceddeploymentTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_apps_v1_namespaces_namespace_deployments",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listappsv1namespaceddeploymentHandler(cfg),
	}
}

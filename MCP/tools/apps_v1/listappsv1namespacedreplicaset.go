...
func Listappsv1namespacedreplicasetHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListappsv1namespacedreplicasetTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_apps_v1_namespaces_namespace_replicasets",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listappsv1namespacedreplicasetHandler(cfg),
	}
}

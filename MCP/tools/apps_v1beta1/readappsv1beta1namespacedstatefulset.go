...
func Readappsv1beta1namespacedstatefulsetHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReadappsv1beta1namespacedstatefulsetTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_apps_v1beta1_namespaces_namespace_statefulsets_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Readappsv1beta1namespacedstatefulsetHandler(cfg),
	}
}

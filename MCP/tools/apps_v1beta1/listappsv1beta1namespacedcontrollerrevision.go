...
func Listappsv1beta1namespacedcontrollerrevisionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListappsv1beta1namespacedcontrollerrevisionTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_apps_v1beta1_namespaces_namespace_controllerrevisions",
		mcp.WithDescription("list or watch objects of kind ControllerRevision"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listappsv1beta1namespacedcontrollerrevisionHandler(cfg),
	}
}

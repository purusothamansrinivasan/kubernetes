...
func Deleteextensionsv1beta1podsecuritypolicyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeleteextensionsv1beta1podsecuritypolicyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_extensions_v1beta1_podsecuritypolicies_name",
		mcp.WithDescription("delete a PodSecurityPolicy"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deleteextensionsv1beta1podsecuritypolicyHandler(cfg),
	}
}

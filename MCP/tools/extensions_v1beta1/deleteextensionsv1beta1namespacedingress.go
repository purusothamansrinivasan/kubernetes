...
func Deleteextensionsv1beta1namespacedingressHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeleteextensionsv1beta1namespacedingressTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_extensions_v1beta1_namespaces_namespace_ingresses_name",
		mcp.WithDescription("delete an Ingress"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deleteextensionsv1beta1namespacedingressHandler(cfg),
	}
}

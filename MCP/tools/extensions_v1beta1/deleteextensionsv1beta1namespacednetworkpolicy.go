...
func Deleteextensionsv1beta1namespacednetworkpolicyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeleteextensionsv1beta1namespacednetworkpolicyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_extensions_v1beta1_namespaces_namespace_networkpolicies_name",
		mcp.WithDescription("delete a NetworkPolicy"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deleteextensionsv1beta1namespacednetworkpolicyHandler(cfg),
	}
}

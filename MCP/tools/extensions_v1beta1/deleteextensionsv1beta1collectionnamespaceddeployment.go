...
func Deleteextensionsv1beta1collectionnamespaceddeploymentHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/extensions/v1beta1/namespaces/%s/deployments%s", cfg.BaseURL, queryString)
...
func CreateDeleteextensionsv1beta1collectionnamespaceddeploymentTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_extensions_v1beta1_namespaces_namespace_deployments",
		mcp.WithDescription("delete collection of Deployment"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deleteextensionsv1beta1collectionnamespaceddeploymentHandler(cfg),
	}
}

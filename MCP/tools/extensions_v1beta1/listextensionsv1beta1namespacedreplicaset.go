...
func Listextensionsv1beta1namespacedreplicasetHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListextensionsv1beta1namespacedreplicasetTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_extensions_v1beta1_namespaces_namespace_replicasets",
		mcp.WithDescription("list or watch objects of kind ReplicaSet"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listextensionsv1beta1namespacedreplicasetHandler(cfg),
	}
}

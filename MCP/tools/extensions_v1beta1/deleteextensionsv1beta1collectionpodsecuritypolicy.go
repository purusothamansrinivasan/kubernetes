...
func Deleteextensionsv1beta1collectionpodsecuritypolicyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/extensions/v1beta1/podsecuritypolicies%s", cfg.BaseURL, queryString)
...
func CreateDeleteextensionsv1beta1collectionpodsecuritypolicyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_extensions_v1beta1_podsecuritypolicies",
		mcp.WithDescription("delete collection of PodSecurityPolicy"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deleteextensionsv1beta1collectionpodsecuritypolicyHandler(cfg),
	}
}

...
func Listextensionsv1beta1podsecuritypolicyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListextensionsv1beta1podsecuritypolicyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_extensions_v1beta1_podsecuritypolicies",
		mcp.WithDescription("list or watch objects of kind PodSecurityPolicy"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listextensionsv1beta1podsecuritypolicyHandler(cfg),
	}
}

...
func Deleteextensionsv1beta1collectionnamespacedreplicasetHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/extensions/v1beta1/namespaces/%s/replicasets%s", cfg.BaseURL, queryString)
...
func CreateDeleteextensionsv1beta1collectionnamespacedreplicasetTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_extensions_v1beta1_namespaces_namespace_replicasets",
		mcp.WithDescription("delete collection of ReplicaSet"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deleteextensionsv1beta1collectionnamespacedreplicasetHandler(cfg),
	}
}

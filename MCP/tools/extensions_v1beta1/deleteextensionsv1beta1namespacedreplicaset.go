...
func Deleteextensionsv1beta1namespacedreplicasetHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeleteextensionsv1beta1namespacedreplicasetTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_extensions_v1beta1_namespaces_namespace_replicasets_name",
		mcp.WithDescription("delete a ReplicaSet"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deleteextensionsv1beta1namespacedreplicasetHandler(cfg),
	}
}

...
func Listextensionsv1beta1namespacedingressHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListextensionsv1beta1namespacedingressTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_extensions_v1beta1_namespaces_namespace_ingresses",
		mcp.WithDescription("list or watch objects of kind Ingress"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listextensionsv1beta1namespacedingressHandler(cfg),
	}
}

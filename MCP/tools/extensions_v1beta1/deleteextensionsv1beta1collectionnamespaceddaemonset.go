...
func Deleteextensionsv1beta1collectionnamespaceddaemonsetHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/extensions/v1beta1/namespaces/%s/daemonsets%s", cfg.BaseURL, queryString)
...
func CreateDeleteextensionsv1beta1collectionnamespaceddaemonsetTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_extensions_v1beta1_namespaces_namespace_daemonsets",
		mcp.WithDescription("delete collection of DaemonSet"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deleteextensionsv1beta1collectionnamespaceddaemonsetHandler(cfg),
	}
}

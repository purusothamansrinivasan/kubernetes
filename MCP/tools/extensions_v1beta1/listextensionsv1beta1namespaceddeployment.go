...
func Listextensionsv1beta1namespaceddeploymentHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListextensionsv1beta1namespaceddeploymentTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_extensions_v1beta1_namespaces_namespace_deployments",
		mcp.WithDescription("list or watch objects of kind Deployment"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listextensionsv1beta1namespaceddeploymentHandler(cfg),
	}
}

...
func Listadmissionregistrationv1alpha1initializerconfigurationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListadmissionregistrationv1alpha1initializerconfigurationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_admissionregistration.k8s.io_v1alpha1_initializerconfigurations",
		mcp.WithDescription("list or watch objects of kind InitializerConfiguration"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listadmissionregistrationv1alpha1initializerconfigurationHandler(cfg),
	}
}

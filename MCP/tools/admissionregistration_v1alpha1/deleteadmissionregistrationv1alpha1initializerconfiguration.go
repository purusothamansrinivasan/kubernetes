...
func Deleteadmissionregistrationv1alpha1initializerconfigurationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeleteadmissionregistrationv1alpha1initializerconfigurationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_admissionregistration.k8s.io_v1alpha1_initializerconfigurations_name",
		mcp.WithDescription("delete an InitializerConfiguration"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deleteadmissionregistrationv1alpha1initializerconfigurationHandler(cfg),
	}
}

...
func Deleteadmissionregistrationv1alpha1collectioninitializerconfigurationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/admissionregistration.k8s.io/v1alpha1/initializerconfigurations%s", cfg.BaseURL, queryString)
...
func CreateDeleteadmissionregistrationv1alpha1collectioninitializerconfigurationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_admissionregistration.k8s.io_v1alpha1_initializerconfigurations",
		mcp.WithDescription("delete collection of InitializerConfiguration"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deleteadmissionregistrationv1alpha1collectioninitializerconfigurationHandler(cfg),
	}
}

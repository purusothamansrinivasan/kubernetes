...
func Listapiextensionsv1beta1customresourcedefinitionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListapiextensionsv1beta1customresourcedefinitionTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_apiextensions.k8s.io_v1beta1_customresourcedefinitions",
		mcp.WithDescription("list or watch objects of kind CustomResourceDefinition"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listapiextensionsv1beta1customresourcedefinitionHandler(cfg),
	}
}

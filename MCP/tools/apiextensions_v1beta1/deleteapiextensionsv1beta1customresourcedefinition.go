...
func Deleteapiextensionsv1beta1customresourcedefinitionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeleteapiextensionsv1beta1customresourcedefinitionTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_apiextensions.k8s.io_v1beta1_customresourcedefinitions_name",
		mcp.WithDescription("delete a CustomResourceDefinition"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deleteapiextensionsv1beta1customresourcedefinitionHandler(cfg),
	}
}

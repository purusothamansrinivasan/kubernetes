...
func Deleteapiextensionsv1beta1collectioncustomresourcedefinitionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/apiextensions.k8s.io/v1beta1/customresourcedefinitions%s", cfg.BaseURL, queryString)
...
func CreateDeleteapiextensionsv1beta1collectioncustomresourcedefinitionTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_apiextensions.k8s.io_v1beta1_customresourcedefinitions",
		mcp.WithDescription("delete collection of CustomResourceDefinition"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deleteapiextensionsv1beta1collectioncustomresourcedefinitionHandler(cfg),
	}
}

...
func Deleteschedulingv1alpha1priorityclassHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeleteschedulingv1alpha1priorityclassTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_scheduling.k8s.io_v1alpha1_priorityclasses_name",
		mcp.WithDescription("delete a PriorityClass"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deleteschedulingv1alpha1priorityclassHandler(cfg),
	}
}

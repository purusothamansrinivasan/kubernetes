...
func Deleteschedulingv1alpha1collectionpriorityclassHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/scheduling.k8s.io/v1alpha1/priorityclasses%s", cfg.BaseURL, queryString)
...
func CreateDeleteschedulingv1alpha1collectionpriorityclassTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_scheduling.k8s.io_v1alpha1_priorityclasses",
		mcp.WithDescription("delete collection of PriorityClass"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deleteschedulingv1alpha1collectionpriorityclassHandler(cfg),
	}
}

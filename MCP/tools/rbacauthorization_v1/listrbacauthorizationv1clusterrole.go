...
func Listrbacauthorizationv1clusterroleHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListrbacauthorizationv1clusterroleTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_rbac.authorization.k8s.io_v1_clusterroles",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listrbacauthorizationv1clusterroleHandler(cfg),
	}
}

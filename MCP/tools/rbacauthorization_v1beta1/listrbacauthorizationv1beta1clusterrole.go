...
func Listrbacauthorizationv1beta1clusterroleHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListrbacauthorizationv1beta1clusterroleTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_rbac.authorization.k8s.io_v1beta1_clusterroles",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listrbacauthorizationv1beta1clusterroleHandler(cfg),
	}
}

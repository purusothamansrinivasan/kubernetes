...
func Listrbacauthorizationv1beta1clusterrolebindingHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListrbacauthorizationv1beta1clusterrolebindingTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_rbac.authorization.k8s.io_v1beta1_clusterrolebindings",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listrbacauthorizationv1beta1clusterrolebindingHandler(cfg),
	}
}

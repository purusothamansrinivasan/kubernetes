...
func Deleterbacauthorizationv1beta1collectionnamespacedroleHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeleterbacauthorizationv1beta1collectionnamespacedroleTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_rbac.authorization.k8s.io_v1beta1_namespaces_namespace_roles",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deleterbacauthorizationv1beta1collectionnamespacedroleHandler(cfg),
	}
}

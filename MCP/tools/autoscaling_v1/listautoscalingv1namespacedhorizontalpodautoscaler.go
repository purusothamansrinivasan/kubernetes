...
func Listautoscalingv1namespacedhorizontalpodautoscalerHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListautoscalingv1namespacedhorizontalpodautoscalerTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_autoscaling_v1_namespaces_namespace_horizontalpodautoscalers",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listautoscalingv1namespacedhorizontalpodautoscalerHandler(cfg),
	}
}

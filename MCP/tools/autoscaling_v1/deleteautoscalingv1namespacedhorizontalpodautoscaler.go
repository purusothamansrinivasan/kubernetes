...
func Deleteautoscalingv1namespacedhorizontalpodautoscalerHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeleteautoscalingv1namespacedhorizontalpodautoscalerTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_autoscaling_v1_namespaces_namespace_horizontalpodautoscalers_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deleteautoscalingv1namespacedhorizontalpodautoscalerHandler(cfg),
	}
}

...
func Listcorev1namespacedconfigmapHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListcorev1namespacedconfigmapTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_api_v1_namespaces_namespace_configmaps",
		mcp.WithDescription("list or watch objects of kind ConfigMap"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listcorev1namespacedconfigmapHandler(cfg),
	}
}

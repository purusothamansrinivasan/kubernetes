...
func Listcorev1nodeHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListcorev1nodeTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_api_v1_nodes",
		mcp.WithDescription("list or watch objects of kind Node"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listcorev1nodeHandler(cfg),
	}
}

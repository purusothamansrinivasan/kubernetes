...
func Deletecorev1namespacedresourcequotaHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeletecorev1namespacedresourcequotaTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_api_v1_namespaces_namespace_resourcequotas_name",
		mcp.WithDescription("delete a ResourceQuota"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deletecorev1namespacedresourcequotaHandler(cfg),
	}
}

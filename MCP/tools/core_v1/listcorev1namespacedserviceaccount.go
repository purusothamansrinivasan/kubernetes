...
func Listcorev1namespacedserviceaccountHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListcorev1namespacedserviceaccountTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_api_v1_namespaces_namespace_serviceaccounts",
		mcp.WithDescription("list or watch objects of kind ServiceAccount"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listcorev1namespacedserviceaccountHandler(cfg),
	}
}

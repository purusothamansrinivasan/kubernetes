...
func Deletecorev1namespacedconfigmapHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeletecorev1namespacedconfigmapTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_api_v1_namespaces_namespace_configmaps_name",
		mcp.WithDescription("delete a ConfigMap"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deletecorev1namespacedconfigmapHandler(cfg),
	}
}

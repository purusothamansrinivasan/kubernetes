...
func Deletecorev1namespacedeventHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeletecorev1namespacedeventTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_api_v1_namespaces_namespace_events_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deletecorev1namespacedeventHandler(cfg),
	}
}

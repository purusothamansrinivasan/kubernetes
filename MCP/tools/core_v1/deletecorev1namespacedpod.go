...
func Deletecorev1namespacedpodHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeletecorev1namespacedpodTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_api_v1_namespaces_namespace_pods_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deletecorev1namespacedpodHandler(cfg),
	}
}

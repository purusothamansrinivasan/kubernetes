...
func Deletecorev1namespacedlimitrangeHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeletecorev1namespacedlimitrangeTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_api_v1_namespaces_namespace_limitranges_name",
		mcp.WithDescription("delete a LimitRange"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deletecorev1namespacedlimitrangeHandler(cfg),
	}
}

...
func Deletecorev1namespacedpodtemplateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeletecorev1namespacedpodtemplateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_api_v1_namespaces_namespace_podtemplates_name",
		mcp.WithDescription("delete a PodTemplate"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deletecorev1namespacedpodtemplateHandler(cfg),
	}
}

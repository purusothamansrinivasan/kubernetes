...
func Deletecorev1namespacedsecretHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeletecorev1namespacedsecretTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_api_v1_namespaces_namespace_secrets_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deletecorev1namespacedsecretHandler(cfg),
	}
}

...
func Deletecorev1namespaceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeletecorev1namespaceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_api_v1_namespaces_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deletecorev1namespaceHandler(cfg),
	}
}

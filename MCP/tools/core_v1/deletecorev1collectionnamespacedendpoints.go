...
func Deletecorev1collectionnamespacedendpointsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeletecorev1collectionnamespacedendpointsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_api_v1_namespaces_namespace_endpoints",
		mcp.WithDescription("delete collection of Endpoints"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deletecorev1collectionnamespacedendpointsHandler(cfg),
	}
}

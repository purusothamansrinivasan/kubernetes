...
func Listcorev1namespacedreplicationcontrollerHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListcorev1namespacedreplicationcontrollerTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_api_v1_namespaces_namespace_replicationcontrollers",
		mcp.WithDescription("list or watch objects of kind ReplicationController"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listcorev1namespacedreplicationcontrollerHandler(cfg),
	}
}

...
func Listcorev1namespacedlimitrangeHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListcorev1namespacedlimitrangeTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_api_v1_namespaces_namespace_limitranges",
		mcp.WithDescription("list or watch objects of kind LimitRange"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listcorev1namespacedlimitrangeHandler(cfg),
	}
}

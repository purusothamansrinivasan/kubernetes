...
func Deletecorev1namespacedserviceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeletecorev1namespacedserviceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_api_v1_namespaces_namespace_services_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deletecorev1namespacedserviceHandler(cfg),
	}
}

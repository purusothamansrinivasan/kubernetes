...
func Listcorev1namespacedpodtemplateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListcorev1namespacedpodtemplateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_api_v1_namespaces_namespace_podtemplates",
		mcp.WithDescription("list or watch objects of kind PodTemplate"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listcorev1namespacedpodtemplateHandler(cfg),
	}
}

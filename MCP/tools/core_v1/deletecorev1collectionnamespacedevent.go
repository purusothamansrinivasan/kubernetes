...
func Deletecorev1collectionnamespacedeventHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeletecorev1collectionnamespacedeventTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_api_v1_namespaces_namespace_events",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deletecorev1collectionnamespacedeventHandler(cfg),
	}
}

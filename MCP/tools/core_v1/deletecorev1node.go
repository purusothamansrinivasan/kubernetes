...
func Deletecorev1nodeHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeletecorev1nodeTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_api_v1_nodes_name",
		mcp.WithDescription("delete a Node"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deletecorev1nodeHandler(cfg),
	}
}

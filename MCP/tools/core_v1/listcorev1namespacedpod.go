...
func Listcorev1namespacedpodHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListcorev1namespacedpodTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_api_v1_namespaces_namespace_pods",
		mcp.WithDescription("list or watch objects of kind Pod"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listcorev1namespacedpodHandler(cfg),
	}
}

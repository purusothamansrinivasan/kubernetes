...
func Listcorev1namespacedresourcequotaHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListcorev1namespacedresourcequotaTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_api_v1_namespaces_namespace_resourcequotas",
		mcp.WithDescription("list or watch objects of kind ResourceQuota"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listcorev1namespacedresourcequotaHandler(cfg),
	}
}

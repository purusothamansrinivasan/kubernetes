...
func Deletecorev1namespacedendpointsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeletecorev1namespacedendpointsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_api_v1_namespaces_namespace_endpoints_name",
		mcp.WithDescription("delete Endpoints"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deletecorev1namespacedendpointsHandler(cfg),
	}
}

...
func Readcorev1namespacedeventHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReadcorev1namespacedeventTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_api_v1_namespaces_namespace_events_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Readcorev1namespacedeventHandler(cfg),
	}
}

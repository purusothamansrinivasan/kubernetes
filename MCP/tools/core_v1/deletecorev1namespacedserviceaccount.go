...
func Deletecorev1namespacedserviceaccountHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeletecorev1namespacedserviceaccountTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_api_v1_namespaces_namespace_serviceaccounts_name",
		mcp.WithDescription("delete a ServiceAccount"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deletecorev1namespacedserviceaccountHandler(cfg),
	}
}

...
func Deletecertificatesv1beta1certificatesigningrequestHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeletecertificatesv1beta1certificatesigningrequestTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_certificates.k8s.io_v1beta1_certificatesigningrequests_name",
		mcp.WithDescription("delete a CertificateSigningRequest"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deletecertificatesv1beta1certificatesigningrequestHandler(cfg),
	}
}

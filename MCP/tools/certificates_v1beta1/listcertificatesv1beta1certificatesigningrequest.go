...
func Listcertificatesv1beta1certificatesigningrequestHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListcertificatesv1beta1certificatesigningrequestTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_certificates.k8s.io_v1beta1_certificatesigningrequests",
		mcp.WithDescription("list or watch objects of kind CertificateSigningRequest"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listcertificatesv1beta1certificatesigningrequestHandler(cfg),
	}
}

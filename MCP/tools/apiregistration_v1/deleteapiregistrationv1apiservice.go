...
func Deleteapiregistrationv1apiserviceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeleteapiregistrationv1apiserviceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_apiregistration.k8s.io_v1_apiservices_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deleteapiregistrationv1apiserviceHandler(cfg),
	}
}

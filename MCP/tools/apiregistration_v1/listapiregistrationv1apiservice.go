...
func Listapiregistrationv1apiserviceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListapiregistrationv1apiserviceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_apiregistration.k8s.io_v1_apiservices",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listapiregistrationv1apiserviceHandler(cfg),
	}
}

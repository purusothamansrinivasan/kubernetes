...
func Deleteautoscalingv2beta1collectionnamespacedhorizontalpodautoscalerHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/autoscaling/v2beta1/namespaces/%s/horizontalpodautoscalers%s", cfg.BaseURL, queryString)
...
func CreateDeleteautoscalingv2beta1collectionnamespacedhorizontalpodautoscalerTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_autoscaling_v2beta1_namespaces_namespace_horizontalpodautoscalers",
		mcp.WithDescription("delete collection of HorizontalPodAutoscaler"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deleteautoscalingv2beta1collectionnamespacedhorizontalpodautoscalerHandler(cfg),
	}
}

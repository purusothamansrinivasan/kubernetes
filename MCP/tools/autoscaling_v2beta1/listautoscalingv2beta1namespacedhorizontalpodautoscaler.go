...
func Listautoscalingv2beta1namespacedhorizontalpodautoscalerHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListautoscalingv2beta1namespacedhorizontalpodautoscalerTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_autoscaling_v2beta1_namespaces_namespace_horizontalpodautoscalers",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listautoscalingv2beta1namespacedhorizontalpodautoscalerHandler(cfg),
	}
}

...
func Deleteautoscalingv2beta1namespacedhorizontalpodautoscalerHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeleteautoscalingv2beta1namespacedhorizontalpodautoscalerTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_autoscaling_v2beta1_namespaces_namespace_horizontalpodautoscalers_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deleteautoscalingv2beta1namespacedhorizontalpodautoscalerHandler(cfg),
	}
}

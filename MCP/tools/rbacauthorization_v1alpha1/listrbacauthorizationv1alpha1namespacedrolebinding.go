...
func Listrbacauthorizationv1alpha1namespacedrolebindingHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListrbacauthorizationv1alpha1namespacedrolebindingTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_rbac.authorization.k8s.io_v1alpha1_namespaces_namespace_rolebindings",
		mcp.WithDescription("list or watch objects of kind RoleBinding"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listrbacauthorizationv1alpha1namespacedrolebindingHandler(cfg),
	}
}

...
func Listrbacauthorizationv1alpha1clusterroleHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListrbacauthorizationv1alpha1clusterroleTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_rbac.authorization.k8s.io_v1alpha1_clusterroles",
		mcp.WithDescription("list or watch objects of kind ClusterRole"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listrbacauthorizationv1alpha1clusterroleHandler(cfg),
	}
}

...
func Deleterbacauthorizationv1alpha1collectionnamespacedrolebindingHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/rbac.authorization.k8s.io/v1alpha1/namespaces/%s/rolebindings%s", cfg.BaseURL, queryString)
...
func CreateDeleterbacauthorizationv1alpha1collectionnamespacedrolebindingTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_rbac.authorization.k8s.io_v1alpha1_namespaces_namespace_rolebindings",
		mcp.WithDescription("delete collection of RoleBinding"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deleterbacauthorizationv1alpha1collectionnamespacedrolebindingHandler(cfg),
	}
}

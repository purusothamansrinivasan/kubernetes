...
func Deleteadmissionregistrationv1beta1collectionvalidatingwebhookconfigurationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/admissionregistration.k8s.io/v1beta1/validatingwebhookconfigurations%s", cfg.BaseURL, queryString)
...
func CreateDeleteadmissionregistrationv1beta1collectionvalidatingwebhookconfigurationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_admissionregistration.k8s.io_v1beta1_validatingwebhookconfigurations",
		mcp.WithDescription("delete collection of ValidatingWebhookConfiguration"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deleteadmissionregistrationv1beta1collectionvalidatingwebhookconfigurationHandler(cfg),
	}
}

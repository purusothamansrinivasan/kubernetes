...
func Listadmissionregistrationv1beta1validatingwebhookconfigurationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListadmissionregistrationv1beta1validatingwebhookconfigurationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_admissionregistration.k8s.io_v1beta1_validatingwebhookconfigurations",
		mcp.WithDescription("list or watch objects of kind ValidatingWebhookConfiguration"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listadmissionregistrationv1beta1validatingwebhookconfigurationHandler(cfg),
	}
}

...
func Deleteadmissionregistrationv1beta1collectionmutatingwebhookconfigurationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/admissionregistration.k8s.io/v1beta1/mutatingwebhookconfigurations%s", cfg.BaseURL, queryString)
...
func CreateDeleteadmissionregistrationv1beta1collectionmutatingwebhookconfigurationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_admissionregistration.k8s.io_v1beta1_mutatingwebhookconfigurations",
		mcp.WithDescription("delete collection of MutatingWebhookConfiguration"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deleteadmissionregistrationv1beta1collectionmutatingwebhookconfigurationHandler(cfg),
	}
}

...
func Deleteadmissionregistrationv1beta1mutatingwebhookconfigurationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeleteadmissionregistrationv1beta1mutatingwebhookconfigurationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_admissionregistration.k8s.io_v1beta1_mutatingwebhookconfigurations_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deleteadmissionregistrationv1beta1mutatingwebhookconfigurationHandler(cfg),
	}
}

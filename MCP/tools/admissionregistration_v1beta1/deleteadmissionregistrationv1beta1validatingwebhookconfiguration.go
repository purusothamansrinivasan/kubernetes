...
func Deleteadmissionregistrationv1beta1validatingwebhookconfigurationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeleteadmissionregistrationv1beta1validatingwebhookconfigurationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_admissionregistration.k8s.io_v1beta1_validatingwebhookconfigurations_name",
		mcp.WithDescription("delete a ValidatingWebhookConfiguration"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deleteadmissionregistrationv1beta1validatingwebhookconfigurationHandler(cfg),
	}
}

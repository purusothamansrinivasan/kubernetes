...
func Deletebatchv2alpha1namespacedcronjobHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeletebatchv2alpha1namespacedcronjobTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_batch_v2alpha1_namespaces_namespace_cronjobs_name",
		mcp.WithDescription("delete a CronJob"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deletebatchv2alpha1namespacedcronjobHandler(cfg),
	}
}

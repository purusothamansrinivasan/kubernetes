...
func Listbatchv2alpha1namespacedcronjobHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListbatchv2alpha1namespacedcronjobTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_batch_v2alpha1_namespaces_namespace_cronjobs",
		mcp.WithDescription("list or watch objects of kind CronJob"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listbatchv2alpha1namespacedcronjobHandler(cfg),
	}
}

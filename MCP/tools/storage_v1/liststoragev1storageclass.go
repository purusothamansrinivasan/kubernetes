...
func Liststoragev1storageclassHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListstoragev1storageclassTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_storage.k8s.io_v1_storageclasses",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Liststoragev1storageclassHandler(cfg),
	}
}

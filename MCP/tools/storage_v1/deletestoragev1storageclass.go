...
func Deletestoragev1storageclassHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeletestoragev1storageclassTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_storage.k8s.io_v1_storageclasses_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deletestoragev1storageclassHandler(cfg),
	}
}

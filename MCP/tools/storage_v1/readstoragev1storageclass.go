...
func Readstoragev1storageclassHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReadstoragev1storageclassTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_storage.k8s.io_v1_storageclasses_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Readstoragev1storageclassHandler(cfg),
	}
}

...
func Deleteapiregistrationv1beta1apiserviceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeleteapiregistrationv1beta1apiserviceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_apiregistration.k8s.io_v1beta1_apiservices_name",
		mcp.WithDescription("delete an APIService"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deleteapiregistrationv1beta1apiserviceHandler(cfg),
	}
}

...
func Listapiregistrationv1beta1apiserviceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListapiregistrationv1beta1apiserviceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_apiregistration.k8s.io_v1beta1_apiservices",
		mcp.WithDescription("list or watch objects of kind APIService"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listapiregistrationv1beta1apiserviceHandler(cfg),
	}
}

...
func Deleteapiregistrationv1beta1collectionapiserviceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/apiregistration.k8s.io/v1beta1/apiservices%s", cfg.BaseURL, queryString)
...
func CreateDeleteapiregistrationv1beta1collectionapiserviceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_apiregistration.k8s.io_v1beta1_apiservices",
		mcp.WithDescription("delete collection of APIService"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deleteapiregistrationv1beta1collectionapiserviceHandler(cfg),
	}
}

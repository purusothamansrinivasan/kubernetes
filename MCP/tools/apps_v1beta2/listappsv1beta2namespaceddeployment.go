...
func Listappsv1beta2namespaceddeploymentHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListappsv1beta2namespaceddeploymentTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_apps_v1beta2_namespaces_namespace_deployments",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listappsv1beta2namespaceddeploymentHandler(cfg),
	}
}

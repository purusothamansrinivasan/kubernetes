...
func Deleteappsv1beta2namespacedcontrollerrevisionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeleteappsv1beta2namespacedcontrollerrevisionTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_apps_v1beta2_namespaces_namespace_controllerrevisions_name",
		mcp.WithDescription("delete a ControllerRevision"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deleteappsv1beta2namespacedcontrollerrevisionHandler(cfg),
	}
}

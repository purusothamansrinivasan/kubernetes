...
func Readappsv1beta2namespaceddaemonsetHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReadappsv1beta2namespaceddaemonsetTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_apps_v1beta2_namespaces_namespace_daemonsets_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Readappsv1beta2namespaceddaemonsetHandler(cfg),
	}
}

...
func Deletebatchv1beta1namespacedcronjobHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeletebatchv1beta1namespacedcronjobTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_batch_v1beta1_namespaces_namespace_cronjobs_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deletebatchv1beta1namespacedcronjobHandler(cfg),
	}
}

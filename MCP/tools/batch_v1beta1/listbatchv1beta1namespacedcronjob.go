...
func Listbatchv1beta1namespacedcronjobHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListbatchv1beta1namespacedcronjobTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_batch_v1beta1_namespaces_namespace_cronjobs",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listbatchv1beta1namespacedcronjobHandler(cfg),
	}
}

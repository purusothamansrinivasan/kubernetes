...
func Deletepolicyv1beta1podsecuritypolicyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeletepolicyv1beta1podsecuritypolicyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_policy_v1beta1_podsecuritypolicies_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deletepolicyv1beta1podsecuritypolicyHandler(cfg),
	}
}

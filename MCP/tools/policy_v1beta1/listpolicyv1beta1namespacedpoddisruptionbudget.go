...
func Listpolicyv1beta1namespacedpoddisruptionbudgetHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListpolicyv1beta1namespacedpoddisruptionbudgetTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_policy_v1beta1_namespaces_namespace_poddisruptionbudgets",
		mcp.WithDescription("list or watch objects of kind PodDisruptionBudget"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listpolicyv1beta1namespacedpoddisruptionbudgetHandler(cfg),
	}
}

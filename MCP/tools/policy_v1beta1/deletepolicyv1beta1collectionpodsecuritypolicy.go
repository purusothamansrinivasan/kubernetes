...
func Deletepolicyv1beta1collectionpodsecuritypolicyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/policy/v1beta1/podsecuritypolicies%s", cfg.BaseURL, queryString)
...
func CreateDeletepolicyv1beta1collectionpodsecuritypolicyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_policy_v1beta1_podsecuritypolicies",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deletepolicyv1beta1collectionpodsecuritypolicyHandler(cfg),
	}
}

...
func Deletepolicyv1beta1namespacedpoddisruptionbudgetHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeletepolicyv1beta1namespacedpoddisruptionbudgetTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_policy_v1beta1_namespaces_namespace_poddisruptionbudgets_name",
		mcp.WithDescription("delete a PodDisruptionBudget"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deletepolicyv1beta1namespacedpoddisruptionbudgetHandler(cfg),
	}
}

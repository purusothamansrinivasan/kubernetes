...
func Listpolicyv1beta1podsecuritypolicyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListpolicyv1beta1podsecuritypolicyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_policy_v1beta1_podsecuritypolicies",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listpolicyv1beta1podsecuritypolicyHandler(cfg),
	}
}
